...
banner: './banner/ArcaneRoots.jpg'
avatar: './avatar/ArcaneRoots.png'
...
tags: ['alternative rock', 'post-hardcore']
---
...
<AudioTitle
	client:only="react"
	startFromInSeconds={60}
	durationInSeconds={34}
	cloudinaryPath="v1680253640/audio/arcane-roots/ifNothingBreaks.m4a"
...
<AudioTitle
	client:only="react"
	startFromInSeconds={80}
	durationInSeconds={47}
	cloudinaryPath="v1680253140/audio/arcane-roots/sacredShapes.m4a"
...
<AudioTitle
	...
	cloudinaryPath="v1680244552/audio/arcane-roots/halfTheWorld.m4a"
